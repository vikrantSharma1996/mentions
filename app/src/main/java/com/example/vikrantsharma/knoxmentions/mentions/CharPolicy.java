package com.example.vikrantsharma.knoxmentions.mentions;
...
/**
 * A special {@link com.example.vikrantsharma.knoxmentions.mentions.AutocompletePolicy} for cases when you want to trigger the popup when a
